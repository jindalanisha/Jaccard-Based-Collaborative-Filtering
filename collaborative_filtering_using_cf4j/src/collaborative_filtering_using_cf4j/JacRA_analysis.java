...
//			
//		System.out.println();
//		System.out.println(new DecimalFormat("#.#####").format(new JacRA().similarity(x,user2)));
		...
		double testUsers = 0.10; 
		double testItems = 0.10; 
		

		Kernel.getInstance().open(dbName, testUsers, testItems,"::");
		//Kernel.getInstance().open(dbName, testUsers, testItems,"\t");

		String [] similarityMetrics = {"JacRA", "PCC","cosine","Jaccard","MSD","JMSD","CJMSD"};
		int [] numberOfNeighbors = {5,10,15,20,25,30,35,40};

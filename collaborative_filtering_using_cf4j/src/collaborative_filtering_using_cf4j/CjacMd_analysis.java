...
//			
//		System.out.println();
//		System.out.println(new DecimalFormat("#.#####").format(new CjacMD().similarity(x,user2)));
		...
		String [] similarityMetrics = {"CjacMD", "PCC","cosine","Jaccard","MSD","JMSD","CJMSD"};
		int [] numberOfNeighbors = {10,20,30,50,70,100,150,200};
		...
		for (String sm : similarityMetrics) {
			...
			for (int k : numberOfNeighbors) {
				...
				RMSE.putError(k, sm,(Double)Math.sqrt(Kernel.gi().getQualityMeasure("MSD")));
